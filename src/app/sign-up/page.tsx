...
import { AlertCircle, GraduationCap, User, Mail, Lock, Eye, EyeOff, ArrowRight } from "lucide-react";
...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (envMissing) {
      ...
      if (typeof window !== "undefined") {
        ...
        existingMockUsers[email.toLowerCase()] = mockUser;
  ...
  const handleGoogleSignUp = async () => {
    ...
    if (envMissing) {
      console.info("Supabase configuration missing, entering Demo Mode via Google sign-up.");
      const mockUser = {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-[#fefae0] font-sans">
      ...
      <div className="flex flex-col md:flex-row flex-grow w-full pt-16">
        ...
        {/* Left Section: Sign-Up Form Card */}
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="font-sans text-xs text-[#01472e]/60 font-medium">
                Start your personalised study journey
              </p>
            </div>
            ...
            {successMsg && (
              <div className="flex items-start gap-2 bg-[#01472e]/5 border border-[#01472e]/15 text-[#01472e] text-xs rounded-xl p-3.5 mb-6 font-medium text-left">
                <AlertCircle className="w-4 h-4 shrink-0 mt-0.5" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-3 bg-white border border-[#01472e]/10 rounded-2xl px-4 py-2.5 focus-within:border-[#01472e]/30 transition-all duration-300 focus-within:bg-white focus-within:shadow-sm">
                ...
                <div className="flex-grow flex flex-col text-left">
                  <label htmlFor="fullName" className="font-mono text-[8px] font-bold text-[#01472e]/50 uppercase tracking-wider mb-0.5">
                    Full name
                  </label>
                  <input 
                    type="text" 
              ...
              <p className="text-[9px] text-[#01472e]/50 text-left pl-2 mt-1">
              ...
              <motion.button 
                ...
                initial={{ width: 44 }}
                animate={{ 
                  width: loading ? 200 : (isHovered ? 200 : 44),
                }}
            ...
            <div className="text-center mt-6 text-xs text-[#01472e]/60 font-sans">
              ...
              <Link href="/sign-in" className="text-[#01472e] hover:text-[#01472e]/85 font-bold underline transition-colors cursor-pointer">
                Sign in
              </Link>
            </div>
          </motion.div>
        ...
        {/* Right Section: Interactive 3D Robot Spline surrounded by showcase cards */}
        <div className="w-full md:w-1/2 bg-[#ccd5ae] flex items-center justify-center relative overflow-hidden border-t md:border-t-0 md:border-l border-[#01472e]/10 min-h-[50vh] md:min-h-[calc(100vh-4rem)]">
