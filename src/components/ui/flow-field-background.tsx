...
interface NeuralBackgroundProps {
  ...
  speed?: number;
  /**
   * Scale prop added to prevent type-checking errors from demo component.
   */
  scale?: number;
  /**
   * Background color of the container and trails.
   * Default: "#000000"
   */
...
export default function NeuralBackground({
  ...
  useEffect(() => {
    ...
    // Convert hex background color to RGB for trail opacity mapping
